...
public class SysPropertyUtils {
    ...
    private static final String LOAD_PROPERTIES = "SELECT name,prop_value FROM sn_sys_property";
    private static final String UPDATE_PROPERTY = "UPDATE sn_sys_property SET prop_value=? WHERE name=?";
