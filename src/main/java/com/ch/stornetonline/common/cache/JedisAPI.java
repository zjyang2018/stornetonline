package com.ch.stornetonline.common.cache;

import java.util.List;
import java.util.Map;
import java.util.Set;

import com.ch.stornetonline.common.utils.SysPropertyUtils;
...
public class JedisAPI {
    ...
    public static Jedis getResource() {
        if (pool == null) {
            ...
            String server = SysPropertyUtils.getInstance().getProperty("stornet.redis.server", "127.0.0.1");
            int port = Integer.parseInt(SysPropertyUtils.getInstance().getProperty("stornet.redis.port", "6379"));
            String password = SysPropertyUtils.getInstance().getProperty("stornet.redis.password", "root");
