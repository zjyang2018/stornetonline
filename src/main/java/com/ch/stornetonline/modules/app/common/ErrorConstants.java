...
public class ErrorConstants {
	...
	public static final String ERRORCODE_USERNO_NULL = "100000";
	public static final String ERRORMSG_USERNO_NULL = "用户号不能为空";
	...
	public static final String ERRORCODE_MPHONE_NULL = "100003";
	public static final String ERRORMSG_MPHONE_NULL = "手机号不能为空";
	...
	public static final String ERRORCODE_ACT_NULL = "100020";
	public static final String ERRORMSG_ACT_NULL = "ACT不能为空";
	
	public static final String ERRORCODE_COMM_NULL = "100021";
	...
	public static final String ERRORCODE_PARAM_NULL = "100028";
	public static final String ERRORMSG_PARAM_NULL = "参数不能为空";
	
	public static final String ERRORCODE_PARAM_ERROR = "100029";
	...
	public static final String ERRORMSG_NO_PERMISSION = "您没有权限管理用户中心";
	
	public static final String ERRORCODE_USER_NOEXIST = "800003";
	public static final String ERRORMSG_USER_NOEXIST = "用户不存在";
	
	public static final String ERRORCODE_APPID_APPLICATION = "800004";
	public static final String ERRORMSG_APPIDID_APPLICATION = "请认证平台";
	...
	public static final String ERRORMSG_REREG_ERROR = "手机号已注册了,请直接登录";
	
	public static final String ERRORCODE_PWD_OLD_ERROR = "800007";
	public static final String ERRORMSG_PWD_OLD_ERROR = "原密码不对";
	...
	public static final String ERRORCODE_MERCHANT_APPLY_ERROR = "800012";
