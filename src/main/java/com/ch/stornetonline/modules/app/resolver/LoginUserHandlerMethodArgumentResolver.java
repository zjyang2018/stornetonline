package com.ch.stornetonline.modules.app.resolver;

import com.ch.stornetonline.common.bean.ResultBean;
import com.ch.stornetonline.modules.app.annotation.LoginUser;
...
public class LoginUserHandlerMethodArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public boolean supportsParameter(MethodParameter parameter) {
        return parameter.getParameterType().isAssignableFrom(SnOlUserInfo.class) && parameter.hasParameterAnnotation(LoginUser.class);
    }
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer container,
        ...
        //获取用户信息
        ResultBean user = snOlUserInfoService.info(object.toString());
